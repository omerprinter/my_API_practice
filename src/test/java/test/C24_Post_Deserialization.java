...
public class C24_Post_Deserialization extends HerokuappBaseUrl {
   ...
   */
    ...
    public void post01(){
        ...
        Assert.assertEquals( ((Map)expData.get("booking")).get("firstname")      , ((Map)respMap.get("booking")).get("firstname") );
        Assert.assertEquals( ((Map)expData.get("booking")).get("lastname")       , ((Map)respMap.get("booking")).get("lastname") );
        Assert.assertEquals( ((Map)expData.get("booking")).get("totalprice")     , ((Map)respMap.get("booking")).get("totalprice") );
        Assert.assertEquals( ((Map)expData.get("booking")).get("depositpaid")    , ((Map)respMap.get("booking")).get("depositpaid") );
        Assert.assertEquals( ((Map)expData.get("booking")).get("additionalneeds"), ((Map)respMap.get("booking")).get("additionalneeds") );
